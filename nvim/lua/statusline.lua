...
--- Current file path (replaces winbar).
---@return string
function M.filepath_component()
  return require("winbar").render()
end
...
vim.api.nvim_create_autocmd("LspProgress", {
  group = vim.api.nvim_create_augroup("bzasc/statusline", { clear = true }),
...
function M.render()
  ...
  return table.concat({
    concat_components({
      M.mode_component() .. " " .. M.filepath_component(),
      M.git_component(),
